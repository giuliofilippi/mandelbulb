...
if os.path.exists("pickles/contactpixelgrid5.pkl")==False:
    ...
    with open('pickles/contactpixelgrid5.pkl','wb') as pickle_file:
        pickle.dump(arr,pickle_file)

else:
    with open('pickles/contactpixelgrid5.pkl','rb') as pickle_file:

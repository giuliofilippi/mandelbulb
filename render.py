...
if os.path.exists("pickles/contactpixelgrid6.pkl")==False:
    ...
    with open('pickles/contactpixelgrid6.pkl','wb') as pickle_file:
        pickle.dump(arr,pickle_file)

else:
    with open('pickles/contactpixelgrid6.pkl','rb') as pickle_file:
